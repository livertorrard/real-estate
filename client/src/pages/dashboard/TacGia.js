...
const TABLE_HEAD = [
  ...
  { id: 'Số điện thoại', label: 'Số điện thoại', alignRight: false },
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          ...
          links={[
            ...
            { name: 'Tác giả', href: PATH_DASHBOARD.tacgia.root },
          ]}
        />
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {datas
                        ...
                        .map((row) => {
                          const { tg_id, tg_ten, tg_email, tg_phone, active } = row;
                          const isItemSelected = selected.indexOf(tg_id) !== -1;
                          return (
                            <TableRow
                              hover
                              key={tg_id}
                                ...
                                <IconButton>
                                  <Icon
                                    ...
                                    onClick={() =>
                                      setEdit({
                                        isEdit: true,
                                        current: { id: tg_id, tg_ten: tg_ten, tg_email: tg_email, tg_phone: tg_phone},
                                      })
                                    }
                                  />
                                </IconButton>
